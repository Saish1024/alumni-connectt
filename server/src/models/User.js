...
const userSchema = new mongoose.Schema({
  ...
  company: { type: String, required: function() { return this.isNew && this.role === 'alumni'; } },
  jobTitle: { type: String, required: function() { return this.isNew && ['alumni', 'faculty'].includes(this.role); } },
  industry: { type: String, required: function() { return this.isNew && ['student', 'alumni'].includes(this.role); } },
  location: { type: String },
  skills: { type: [String], default: [] },
  bio: { type: String },
  linkedin: { type: String, required: function() { return this.isNew && this.role === 'alumni'; } },
